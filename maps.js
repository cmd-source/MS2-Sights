...
var marker4 = L.marker([51.8985, -8.4756]).bindPopup("<a href='https://en.wikipedia.org/wiki/Cork_(city)' target='_blank'><b>Cork</b></a><br>Cork is the second largest city in Ireland.</br><img class='place' src='assets/img/cork.jfif'>").openPopup();
...
var marker = L.marker([53.3498, -6.2603]).bindPopup("<a href='https://en.wikipedia.org/wiki/Dublin' target='_blank'><b>Dublin City</b></a> <br>Dublin is Ireland's Capital and is an attracting in of itself with Europes biggest park nearby the Phoneix Park.</br><img class='place' src='assets/img/dublin.jpg'>").openPopup();
...
var hotel2 = L.marker([53.34949894347942, -6.241970478425741], {icon: myIcon}).bindPopup("<a href='https://www.thespencerhotel.com/'><h6>Spencer Hotel.</h6></a><br/>Excise Walk<br/> International Financial Services Centre<br/>4 Star");
...
var hotel5 = L.marker([53.28037996930549, -9.021767145996693], {icon: myIcon}).bindPopup("<a href='https://www.theconnacht.ie/?utm_source=google&utm_medium=organic&utm_campaign=Knowledge_Graph' target='_blank'><h6>The Connacht Hotel</h6></a><br/>Old Dublin Rd<br/>Galway<br/>4 Star");

//layers added with the help of this video: https://www.youtube.com/watch?v=Nl7KxXHpl5o&t=124s 

var sights = L.layerGroup([marker, marker2, marker3, marker4, marker5, marker6, marker7, marker8, marker9]);
var hotel = L.layerGroup([hotel1, hotel2, hotel3]);
